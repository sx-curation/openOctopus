...
def get_moving_average_signals(ticker: str, lookback_days: int = 250) -> dict:
    """
    Calculate 50-day and 120-day SMAs and detect golden/death cross signals.
    """
    try:
        ...
        # Detect most recent crossover (MA50 crossing MA50)
        signal = "neutral"
        last_crossover_date = None

        if ma50 is not None and ma120 is not None:
            # Find rows where both MAs are valid
