...
const I18N = (() => {
  ...
  const dict = {
    en: {
      ...
      'fh.input.placeholder':      'Ticker, e.g. AAPL',
      'fh.select.placeholder':     '— From Backlog —',
      'fh.btn.analyze':            'Analyze',
      'fh.btn.summary':            'Generate Summary',
      'fh.btn.drilldown':          'Analyze Contribution',
      'fh.btn.retry':              'Retry',
      'fh.score.label':            'Health Score / 100',
      'fh.tab.indicators':         'Indicator & Scoring',
      'fh.tab.drilldown':          'Contribution Drill Down',
      ...
      'fh.drilldown.hint':         'Uses financial data + latest transcript (if available)',
      'fh.drilldown.analyzing':    'Analyzing contributions…',
    ...
    zh: {
      ...
      'fh.label':                  '篩選器 · 財務健康',
      'fh.title':                  '財務健康評分',
      'fh.input.placeholder':      '代碼，如 AAPL',
      'fh.select.placeholder':     '— 從待追蹤清單選擇 —',
      'fh.btn.analyze':            '分析',
      'fh.btn.summary':            '生成摘要',
      'fh.btn.drilldown':          '分析貢獻度',
      'fh.btn.retry':              '重試',
      'fh.score.label':            '健康評分 / 100',
      'fh.tab.indicators':         '指標與評分',
      'fh.tab.drilldown':          '貢獻度拆解',
      'fh.loading':                '載入財務數據中…',
      ...
      'fh.drilldown.hint':         '結合財務數據 + 最新法說會逐字稿（如有）',
      'fh.drilldown.analyzing':    '分析貢獻度中…',
      'fh.group.growth':           '成長',
      'fh.group.health':           '健康',
      'fh.group.risk':             '風險',
